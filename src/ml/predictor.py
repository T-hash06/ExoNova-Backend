...
def predict_tabular_mock(input_data: Dict[str, float]) -> Tuple[float, float, Dict[str, float]]:
    """
...
def _generate_mock_feature_weights(feature_names: list) -> Dict[str, float]:
    ...
    important_features = [
        'pl_trandep', 'pl_orbper', 'pl_trandur', 'st_teff', 'sy_gmag',
        'pl_ratror', 'st_rad', 'pl_insol', 'st_mass', 'sy_jmag',
        'sy_hmag', 'sy_kmag', 'pl_eqt', 'st_met', 'pl_ratdor',
        'st_logg', 'pl_imppar', 'sy_rmag', 'sy_imag', 'sy_zmag'
    ]
